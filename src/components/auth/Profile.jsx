                ...
                <div className='row g-0'>
                  ...
                  <div className='col-md-10'>
                    <div className='card-body'>
                      ...
                      <div className='form-group row'>
                        <label className='col-md-2 col-form-label fw-bold'>Name: </label>
                        <div className='col-md-10'>
                  ...
                  <tbody>
                    {bookings.map((booking, index) => (
                      <tr key={index}>
                        ...
                        <td>
                          {moment(booking.checkInDate).subtract(1, "month").format("MMM DD, YYYY")}
                        </td>
                        <td>
                        {moment(booking.checkOutDate).subtract(1, "month").format("MMM DD, YYYY")}
                        </td>
